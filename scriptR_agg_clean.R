...
saveRDS(brain_filtered_2, file = ".../Analysis_4samplesAggregated/brain_filtered_2.rds")
...
cellchat.COVID <- readRDS(".../Analysis_4samplesAggregated/cellchat_COVID.rds")
...
cellchat.MERGED.reduced <- readRDS(".../Analysis_4samplesAggregated/cellchat_MERGED.noEpCVSM.rds")
